...
class Grade10Serializer private constructor(outputStream: OutputStream) : Output(outputStream) {
    ...
    private fun writeExecutionModel(executionModel: ExecutionModel) {
        ...
        // 0. For sanity checking: timeslice granularity of the execution model
        writeVarLong(executionModel.T.nanosecondsPerTimeslice, true)
        // 1. Number of phases
    ...
    private fun writeResourceModel(resourceModel: ResourceModel) {
        ...
        // 0. For sanity checking: timeslice granularity of the resource model
        writeVarLong(resourceModel.T.nanosecondsPerTimeslice, true)
