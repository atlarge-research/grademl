...
import science.atlarge.grade10.examples.tensorflow.TensorFlowPlatform
...
class CliState(
    ...
    val phaseList = PhaseList.fromExecutionModel(grade10JobResult.executionModel)
