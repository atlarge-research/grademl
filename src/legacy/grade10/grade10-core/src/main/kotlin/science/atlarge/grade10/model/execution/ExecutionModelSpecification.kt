 ...
 * @property[areInstancesInterchangeable] true iff instances of this phase type are interchangeable, e.g., their work
 *         is identical on a different subset of some shared input.
 ...
 */
sealed class PhaseTypeRepeatability(
        val isRepeatable: Boolean,
        val areInstancesInterchangeable: Boolean,
     ...
     */
    object NonRepeated : PhaseTypeRepeatability(false, false)
     ...
     */
    class SequentialRepeated(repetitionKey: String) : PhaseTypeRepeatability(true, false, repetitionKey)
     ...
     * an instance of a phase type.
     */
    class ConcurrentRepeated(repetitionKey: String) : PhaseTypeRepeatability(true, true, repetitionKey)

    /**
     * Indicates that more than one instance of a phase type can be executed with arbitrary precedence constraints
     * between them. Phase instances without a (transitive) dependency can run in any order and overlapping.
     *
     * A keyword must be specified to indicate how instances are identified (e.g., "index", "thread",
     * "node_id"). This may be used to associate [Records][science.atlarge.grade10.records.Record] with
     * an instance of a phase type.
     */
    class DAGRepeated(repetitionKey: String) : PhaseTypeRepeatability(true, false, repetitionKey)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (areInstancesInterchangeable != other.areInstancesInterchangeable) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + areInstancesInterchangeable.hashCode()
